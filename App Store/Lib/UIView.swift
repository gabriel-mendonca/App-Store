...
extension UIView {
    ...
    func centralizarSuperView(size: CGSize = .zero) {
        ...
        if let centerSuperViewX = superview?.centerXAnchor {
            centerXAnchor.constraint(equalTo: centerSuperViewX).isActive = true
        }
        
        if let centerSuperViewY = superview?.centerYAnchor {
            centerYAnchor.constraint(equalTo: centerSuperViewY).isActive = true
        }
